...
function iniciarSesion() {
  ...
  // Enviar solicitud AJAX al servidor para autenticar al usuario
  $.ajax({
    url: 'login.php',
    type: 'POST',
    ...
    success: function(response) {
      if (response.success) {
        // Guardar token de sesión en el almacenamiento local
...
function cerrarSesion() {
  // Eliminar token de sesión del almacenamiento local
