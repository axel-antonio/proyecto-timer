...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <h2>Crear Nueva Alerta para: <?php echo htmlspecialchars($computadora['nombre']); ?></h2>

        <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>

        <?php echo form_open('alertas/guardar'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="mensaje" class="form-control" value="<?php echo set_value('mensaje'); ?>" required>
            </div>

            <div class="form-group">
                <label for="sticker">URL del Sticker</label>
                <input type="url" name="sticker" class="form-control" value="<?php echo set_value('sticker'); ?>" placeholder="https://example.com/sticker.png" required>
